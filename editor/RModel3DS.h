...
public:
    material3DS():m_hasTextureMap(false),m_hasBumpMap(false),m_twoSided(false),m_compiledList(0){}
        ...
        void setList(const int listID){m_compiledList = listID;}
...
public:
    ...
    void buildMesh();
        ...
        void setWaved (bool wave) {m_wave = wave; m_waveTick = 500; for (int a=0;a < 314;a++) m_Sines[a] = sin (((double)a*2)/10)/6;}
